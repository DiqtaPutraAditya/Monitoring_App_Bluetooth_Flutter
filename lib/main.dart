...
class _BluetoothDeviceListScreenState extends State<BluetoothDeviceListScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Color.fromARGB(255, 40, 255, 226), 
      ...
      body: Container(
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [const Color.fromARGB(255, 40, 255, 226), const Color.fromARGB(255, 255, 255, 255)],
          ),
        ),
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: const Color.fromARGB(255, 40, 255, 226),
    ...
    body: Container(
      decoration: const BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: [Color.fromARGB(255, 40, 255, 226), Colors.white], // Gradient dari Cyan ke Putih
        ),
      ),
      child: SafeArea(
        child: Padding(
              ...
              if (latest != null)
                Expanded(
                  child: GridView.count(
                    ...
                    mainAxisSpacing: 16,
                    children: [
                      buildInfoCard("Temp", "${latest.temperature} °C", "", const Color.fromARGB(255, 76, 223, 40), Icons.thermostat),
                      buildInfoCard("Humidity", "${latest.humidity}%", "", const Color.fromARGB(255, 7, 108, 190), Icons.water_drop_rounded),
                      buildInfoCard("Light", "${latest.light}", "", const Color.fromARGB(255, 243, 23, 19), Icons.light_mode),
                      buildInfoCard("Status", latest.rain, latest.drying, const Color.fromARGB(255, 255, 251, 3), getWeatherIcon(latest)),
                    ],
                  ),
                )
              else
...
Widget buildInfoCard(String title, String value, String subtitle, Color color, IconData icon) {
  return GestureDetector(
    onTap: () {
      ...
      setState(() {
        // Ubah ukuran atau tampilan card sesuai kebutuhan
      });
    },
